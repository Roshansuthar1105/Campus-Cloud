      ...
      <div className="bg-red-50 border-l-4 border-red-500 p-4 mb-4">
        <div className="flex">
          ...
          <div className="ml-3">
            ...
            <div className="mt-2">
              <button
                onClick={() => navigate('/faculty/preferences')}
    ...
    <div>
      <div className="mb-6 flex items-center justify-between">
        ...
        <div className="flex space-x-3">
          <Link
            to={`/faculty/preferences/${id}/edit`}
          ...
          <Link
            to={`/faculty/preferences/${id}/reports`}
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        ...
        <div className="bg-white shadow rounded-lg overflow-hidden lg:col-span-3">
          <div className="px-4 py-5 sm:px-6 border-b border-gray-200 flex justify-between items-center">
            ...
            <Link
              to={`/faculty/preferences/${id}/submissions`}
              className="text-indigo-600 hover:text-indigo-900 text-sm font-medium"
            >
              View all
            </Link>
                    ...
                    {submissions.map((submission) => (
                      <tr key={submission._id}>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                          <Link
                            to={`/faculty/preferences/${id}/submissions/${submission._id}`}

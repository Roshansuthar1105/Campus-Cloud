      ...
      try {
        ...
        if (process.env.NODE_ENV === "development") {
          ...
          const mockQuiz = {
            ...
            description:
              "This quiz covers HTML, CSS, JavaScript basics, and responsive design principles.",
            course: {
              _id: "course123",
    ...
    <div>
            ...
            <div>
              <div className="flex items-center mb-4">
                ...
                <span className="text-sm text-gray-700">
                  Time Limit: {quiz?.timeLimit || 60} minutes
                </span>
              </div>
              <div className="flex items-center mb-4">
              ...
              <div className="flex items-center">
                ...
                <span className="text-sm text-gray-700">
                  Status:{" "}
                  {quiz.published || quiz.isPublished ? "Published" : "Draft"}
                </span>
              </div>
            </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="text-lg font-semibold text-gray-900">
                    {stats?.totalSubmissions || quiz?.submissions?.length || 0}
                  </p>
                </div>
                <div>
      ...
      <div className="bg-white shadow rounded-lg overflow-hidden">
        <div className="px-4 py-5 sm:px-6 border-b border-gray-200">
          ...
          <p className="mt-1 max-w-2xl text-sm text-gray-500">
            Total: {quiz?.questions?.length || 0} questions (
                          ...
                          <li key={option._id} className="flex items-center">
                            <div
                              className={`h-4 w-4 rounded mr-2 ${
                                ...
                                question.correctAnswers.includes(option._id)
                                  ? "bg-green-500"
                                  : "bg-gray-200"
                              }`}
                            ></div>
                    ...
                    <div className="mt-4 ml-8">
                      ...
                      <div className="bg-gray-50 p-3 rounded-md">
                        <p className="text-sm text-gray-500 italic">
                          Students will provide a written response to this
                          question.
                        </p>
                      </div>
                    </div>

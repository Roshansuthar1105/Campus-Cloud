...
const PreferenceFormCreate = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    endDate: '',
    isPublished: false,
    targetAudience: 'students', // Default to students for most forms
    questions: []
  });
              ...
              <div className="sm:col-span-3">
                ...
                <div className="mt-1">
                  <select
                    ...
                    className={`shadow-sm focus:ring-purple-500 focus:border-purple-500 block w-full sm:text-sm border-gray-300 rounded-md ${formData.targetAudience !== 'specific-course' ? 'bg-gray-100' : ''}`}
                  >

          ...
          <div className="flex flex-col flex-grow overflow-y-auto">
            <nav className="flex-1 px-2 py-4 space-y-1">
              <Link
                ...
                className={`flex items-center px-4 py-2 text-sm font-medium rounded-md hover:bg-indigo-700 ${isActive('/faculty/dashboard')}`}
              >
              ...
              <Link
                to="/faculty/courses"
                className={`flex items-center px-4 py-2 text-sm font-medium rounded-md hover:bg-indigo-700 ${isActive('/faculty/courses')}`}
              >
              ...
              <Link
                to="/faculty/quizzes"
                className={`flex items-center px-4 py-2 text-sm font-medium rounded-md hover:bg-indigo-700 ${isActive('/faculty/quizzes')}`}
              >
              ...
              <Link
                to="/faculty/reports"
                className={`flex items-center px-4 py-2 text-sm font-medium rounded-md hover:bg-indigo-700 ${isActive('/faculty/reports')}`}
              >
              ...
              <Link
                to="/faculty/profile"
                className={`flex items-center px-4 py-2 text-sm font-medium rounded-md hover:bg-indigo-700 ${isActive('/faculty/profile')}`}
              >
              ...
              <button
                ...
                className="w-full flex items-center px-4 py-2 text-sm font-medium rounded-md hover:bg-indigo-700"
              >
